...
export const resourcePages: PageContent[] = [
  {
    ...
    sections: [
      ...
      { kind: "components", eyebrow: "Latest", title: "More from the Lavelle Networks team", items: [
        { title: "Building a SASE Architecture for the Indian Hybrid Enterprise", href: "/resources/case-studies", linkLabel: "Read", bullets: ["SASE \u00b7 Whitepaper", "A practical guide to converging networking and security for distributed workforces, multi-cloud environments, and regulated industries.", "October 2024 \u00b7 12 min"] },
      ...
      { kind: "platform", eyebrow: "Resource Library", title: "More ways to learn from a decade of deployments.", links: [
        ...
        { title: "Whitepapers", body: "Technical depth on architecture, security, and operations.", href: "/resources/case-studies" },
        { title: "Webinars", body: "Live and on-demand sessions from our network engineers.", href: "/resources/case-studies" }] },
    ],
  },
];
